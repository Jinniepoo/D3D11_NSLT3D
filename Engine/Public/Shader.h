...
public:
	...
	HRESULT Bind_CameraPosition(const _char* pConstantName, const _float3& cameraPosition);
	HRESULT Bind_EffectDistance(const _char* pConstantName, _float effectDistance);
