...
class CMonster_CrumbleB final : public CGameObject
{
public:
...
private:
	CMonster_CrumbleB(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CMonster_CrumbleB(const CMonster_CrumbleB& rhs);
	virtual ~CMonster_CrumbleB() = default;
...
public:
	static CMonster_CrumbleB* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
